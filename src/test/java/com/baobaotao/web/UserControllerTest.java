...
//    @Test
	public void testhandle41() {
		...
		restTemplate.postForLocation(
				"http://localhost:8080/springtest/user/handle41",form);
	}
...
//	@Test
	public void testhandle42() throws IOException{
		...
		byte[] response = restTemplate.postForObject(
				"http://localhost:8080/springtest/user/handle42/{itemId}.html",null,byte[].class,"1233");
...
//	@Test
	public void testhandle43() {
		...
		form.add("age", "45");
		restTemplate.postForLocation(
				"http://localhost:8080/springtest/user/handle43.html",form);
	}
...
//    @Test
	public void testhandle44() throws IOException{
		RestTemplate restTemplate = new RestTemplate();
		byte[] response = restTemplate.postForObject(
				"http://localhost:8080/springtest/user/handle44/{itemId}.html",null,byte[].class,"1233");
		Resource outFile = new FileSystemResource("d:/image_copy.jpg");
		FileCopyUtils.copy(response, outFile.getFile());
	}
...
//    @Test
	public void testhandle51WithXml(){	
		...
		ResponseEntity<User> responseEntity = restTemplate.exchange(
			   "http://localhost:8080/springtest/user/handle51.html",
...
//	@Test
	public void testhandle61() {
		...
		String html = restTemplate.postForObject(
				"http://localhost:8080/springtest/user/handle61.html",form,String.class);
...
//	@Test
	public void testhandle62() {
		RestTemplate restTemplate = new RestTemplate();
		String html = restTemplate.postForObject(
				"http://localhost:8080/springtest/user/handle62.html",null,String.class);
		Assert.assertNotNull(html);
...
//	@Test
	public void testhandle63() {
		RestTemplate restTemplate = new RestTemplate();
		String html = restTemplate.postForObject(
				"http://localhost:8080/springtest/user/handle63.html",null,String.class);
		Assert.assertNotNull(html);
		Assert.assertTrue(html.indexOf("1001")>-1);
	}
...
//	@Test
	public void testhandle71() {
		...
		form.add("password", "123456");
		form.add("age", "45");
		restTemplate.postForLocation("http://springtest:8080/chapter15/user/handle71.html", form);
	}	
...
//	@Test
	public void testhandle81() {
		...
		String html = restTemplate.postForObject(
				"http://localhost:8080/springtest/user/handle81.html",form,String.class);
		Assert.assertNotNull(html);
...
//	@Test
	public void testhandle82() {
		...
		String html = restTemplate.postForObject(
				"http://localhost:8080/springtest/user/handle82.html",form,String.class);
		Assert.assertNotNull(html);
		Assert.assertTrue(html.indexOf("tom")>-1);
	}
...
//	@Test
	public void testhandle91() {
		...
		form.add("salary", "4,500.00");
		String html = restTemplate.postForObject(
				"http://localhost:8080/springtest/user/handle91",form,String.class);
		Assert.assertNotNull(html);
		Assert.assertTrue(html.indexOf("tom")>-1);
	}		
}
