...
public class UserController {
	...
	@RequestMapping(value = "/showUserListByXls1")
	public String showUserListInExcel1(ModelMap mm) {
		Calendar calendar = new GregorianCalendar();
	...
	@RequestMapping(value = "/showUserListByPdf1")
	public String showUserListInPdf1(ModelMap mm) {
		Calendar calendar = new GregorianCalendar();
